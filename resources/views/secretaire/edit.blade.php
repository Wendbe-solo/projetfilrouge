    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        @csrf
            ...
            <div class="col-lg-10">
                <x-input id="name" class=" form-control" type="text" name="name" value="{{$users->name}}" required  />
            </div>
            </div>
            ...
            <div class="col-lg-10">
                <x-input id="name" class=" form-control" type="text" name="last_name" value="{{$users->last_name}}" required  />
            </div>
            </div>
            ...
            <div class="form-group ">
                  <label for="firstname" class="control-label col-lg-2">Role</label>
                    <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" id="name"  name="role" value="{{$users->role}}" required >
            ...
            <div class="col-lg-10">
                ...
                <x-input id="email" class="form-control" type="email" name="email" value="{{$users->email}}" required />
            </div>
            </div>
